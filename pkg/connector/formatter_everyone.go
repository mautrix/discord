...
// Ported from legacy formatter_everyone.go into pkg/connector (ar M2) — the
// goldmark extension that turns Discord @everyone/@here into Matrix @room.
// The actual @room gating (anti-ping injection FR-69 + power-level check FR-70)
// happens after rendering in convertdiscord.go; this extension only emits the
// @room span.
package connector
